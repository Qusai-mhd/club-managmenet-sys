...
if (category_element) {
    ...
    add_category_button.setAttribute("onclick", "win = window.open('/createCategory', 'newwindow', 'width=1000,height=480'); return false;");
    add_category_button.setAttribute("id", "create_category");
    add_category_button.setAttribute("class", "btn btn-success btn-sm");
